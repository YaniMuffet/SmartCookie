...
public class CookieClicker : MonoBehaviour
{
    ...
    void UpdateScreen()
    {
        ...
        txtTopOvens.text = "Top Ovens = " + TopOvens.ToString();
        txtTopDonations.text = "Top Donations = " + TopDonations.ToString();
    ...
    {
        PlayerPrefs.SetInt("TopOvens", 0);
        PlayerPrefs.SetInt("TopDonations", 0);
    ...
    void SaveData() 
    {
        ...
        {
            TopScore = Cookies;
            PlayerPrefs.SetInt("TopScore", (int)Cookies);
        };

        if (TopOvens < Ovens)
        {
            TopOvens = Ovens;
            PlayerPrefs.SetInt("TopOvens", (int)Ovens);
        };

        if (TopDonations < Donations)
        {
            TopDonations = Donations;
            PlayerPrefs.SetInt("TopDonations", (int)Donations);
        }
    ...
    void ReadData() 
    {
        ...
        */
        ...
        TopScore = PlayerPrefs.GetInt("TopScore",(int)0);
        TopOvens = PlayerPrefs.GetInt("TopOvens", (int)0);
        TopDonations = PlayerPrefs.GetInt("TopDonations", (int)0);
